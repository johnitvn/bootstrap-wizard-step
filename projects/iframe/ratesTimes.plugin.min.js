...
},t,o?r:void 0,o,null)}})}),it.fn.size=function(){return this.length},it.fn.andSelf=it.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return it});var or=e.jQuery,ar=e.$;return it.noConflict=function(t){return e.$===it&&(e.$=ar),t&&e.jQuery===it&&(e.jQuery=or),it},typeof t===Ct&&(e.jQuery=e.$=it),it}),function(e){e.fn.clock=function(t){var n={offset:"+0"},r=this,i=e.extend(n,t);setInterval(function(){var t=e.calcTime(i.offset).getSeconds();e(r).find(".sec").html(10>t?"0"+t:t)},1e3),setInterval(function(){var t=e.calcTime(i.offset).getHours(),n=(e.calcTime(i.offset).getMinutes(),12>t?" AM":" PM");e(r).find(".meridiem").html(n);var o=12>t?t:t-12;e(r).find(".hour").html(o+":")},1e3),setInterval(function(){var t=e.calcTime(i.offset).getMinutes();e(r).find(".min").html(t+":")},1e3)}}(jQuery),jQuery.calcTime=function(e){return d=new Date,utc=d.getTime()+6e4*d.getTimezoneOffset(),nd=new Date(utc+36e5*e)},function(e){e.fn.ratesTimes=function(){function t(t,n,r,i){e.ajax({type:"POST",crossDomain:!0,dataType:"jsonp",url:"//rate-exchange.appspot.com/currency?from="+r+"&to="+i,success:function(r){e(t).html(n*parseFloat(r.rate).toFixed(2)+"&nbsp;"+i)}})}var n="Paris",r="Kuala Lumpur",i="+1",o="+8",a=1,s="EUR",l="MYR";this.each(function(){var u='<tr class="title"><th class="l">'+n+'</th><th class="r">'+r+"</th></tr>";u+='<tr class="times">',u+='<td><div class="timeLeft"><span class="hour"></span><span class="min"></span><span class="sec"></span><span class="meridiem"></span></div></td>',u+='<td><div class="timeRight"><span class="hour"></span><span class="min"></span><span class="sec"></span><span class="meridiem"></span></div></td>',u+="</tr>",u+='<tr class="currencies"><td class="from">1 EUR</td><td class="to"> MYR</td></tr>',e(this).html(u),e(this).find(".times .timeLeft").clock({offset:i}),e(this).find(".times .timeRight").clock({offset:o}),e(this).find(".currencies>.from").html(a+"&nbsp;"+s),t(e(this).find(".currencies>.to"),a,s,l)})}}(jQuery);